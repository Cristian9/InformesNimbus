...
<div id="dashboard-header">
    <div class="row" style="margin-left: 1px !important;">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <select class="populate placeholder" id="cbo_areas">
...
<div class="row-fluid">
    ...
    <div id="dashboard_tabs" class="col-xs-12 col-sm-12">
        <div class="box-content no-padding">
            <table class="display table-striped table-heading table-datatable" cellspacing="0" width="100%" id="datatable_area">
                <thead>
                    <tr id="thead">
                        <th>Programa</th>
                        <th>Facultad</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#cbo_areas, #cbo_periodo, #cbo_cat, #input_date, #input_date2').select2();

        cargar_select('cbo_areas', 'area-getAreas');
